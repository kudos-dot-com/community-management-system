    ...
    <div style={{ width: "100%", display: "block" }}>
      <div style={{ width: "96%", display: "block", marginLeft: "15px" }}>
        ...
        <div
          ...
          <h4 style={{ margin: "15px", fontWeight: "bold", fontSize: "15px" }}>
            About {user ? user.role : ""}
          </h4>
          <p style={{ fontSize: "14px", color: "#333", margin: "15px" }}>
          ...
          {user && user.role === "admin" ? (
            <Link to='/form'>
              <a class='waves-effect waves-light btn' style={{ width: "40%" }}>
